...
let dailySummaryDates = [];
let selectedDailySummaryDate = "";
let dailySummaryDatesStatus = "idle";
let dailySummaryStatus = "idle";
let newsStats = null;
let activeFilter = "전체";
let currentPage = 1;
...
const dailySummaryDateSelect = document.querySelector("#dailySummaryDateSelect");
